...
import com.musicreview.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    @Value("${app.cors.allowed-origins:http://localhost:5173,http://127.0.0.1:5173,https://guessband.cn,https://www.guessband.cn}")
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(
                                ...
                                new AntPathRequestMatcher("/api/blog-replies/post/**", HttpMethod.GET.name()),
                ...
                .addFilterAfter(new SpaCsrfCookieFilter(), UsernamePasswordAuthenticationFilter.class);
